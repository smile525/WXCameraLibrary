...
import com.smile525.albumcamerarecorder.settings.GlobalSpec.cleanInstance
import com.smile525.albumcamerarecorder.settings.api.GlobalSettingApi
...
internal constructor(private val multiMediaSetting: MultiMediaSetting, mimeTypes: Set<MimeType>) :
    ...
    override fun videoCompress(videoCompressManager: com.smile525.common.coordinator.VideoCompressCoordinator): GlobalSetting {
    ...
    private fun openMain(requestCode: Int?) {
        ...
        val intent = Intent(activity, TCameraActivity::class.java)
