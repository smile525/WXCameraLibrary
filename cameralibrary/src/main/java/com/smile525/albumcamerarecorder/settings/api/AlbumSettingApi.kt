...
import com.smile525.albumcamerarecorder.album.filter.BaseFilter
import com.smile525.albumcamerarecorder.album.listener.OnCheckedListener
import com.smile525.albumcamerarecorder.album.listener.OnSelectedListener
...
interface AlbumSettingApi {
    ...
    /**
     * 支持的类型：图片，视频
     * 这个优先于 [com.smile525.albumcamerarecorder.settings.MultiMediaSetting.choose]
     * @param mimeTypes 类型
     ...
     * @return [AlbumSetting] this
     * @see com.smile525.albumcamerarecorder.settings.AlbumSpec.onlyShowImages
     * @see com.smile525.albumcamerarecorder.settings.AlbumSpec.onlyShowVideos
     */
