...
import com.smile525.albumcamerarecorder.listener.OnResultCallbackListener
import com.smile525.albumcamerarecorder.settings.AlbumSetting
...
import com.smile525.albumcamerarecorder.settings.GlobalSetting.ScreenOrientation
import com.smile525.albumcamerarecorder.settings.RecorderSetting
...
interface GlobalSettingApi {
    ...
    /**
     * 仅当 [com.smile525.albumcamerarecorder.settings.AlbumSpec.mediaTypeExclusive]
     ...
     *
     * 有两个内置图像引擎：
     * 1. [com.smile525.albumcamerarecorder.album.engine.impl.GlideEngine]
     * 2. [com.smile525.albumcamerarecorder.album.engine.impl.PicassoEngine]
     * 你可以实现你自己的图像引擎。
     *
     ...
     * @return [GlobalSetting] for fluent API.
     */
    fun videoCompress(videoCompressManager: com.smile525.common.coordinator.VideoCompressCoordinator): GlobalSetting
