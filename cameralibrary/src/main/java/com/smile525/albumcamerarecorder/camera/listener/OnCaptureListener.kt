...
interface OnCaptureListener {
     ...
     */
    fun remove(captureData: List<com.smile525.albumcamerarecorder.camera.entity.BitmapData>, position: Int)
     ...
     */
    fun add(captureDatas: List<com.smile525.albumcamerarecorder.camera.entity.BitmapData>, position: Int)
}