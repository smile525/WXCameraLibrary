...
import static com.smile525.albumcamerarecorder.camera.constants.FlashModels.TYPE_FLASH_OFF;
import static com.smile525.albumcamerarecorder.camera.constants.FlashModels.TYPE_FLASH_ON;
import static com.smile525.albumcamerarecorder.constants.Constant.EXTRA_RESULT_SELECTION_LOCAL_FILE;
import static com.smile525.albumcamerarecorder.widget.clickorlongbutton.ClickOrLongButton.BUTTON_STATE_BOTH;
import static com.smile525.albumcamerarecorder.widget.clickorlongbutton.ClickOrLongButton.BUTTON_STATE_CLICK_AND_HOLD;
import static com.smile525.albumcamerarecorder.widget.clickorlongbutton.ClickOrLongButton.BUTTON_STATE_ONLY_CLICK;
import static com.smile525.albumcamerarecorder.widget.clickorlongbutton.ClickOrLongButton.BUTTON_STATE_ONLY_LONG_CLICK;
...
import com.smile525.albumcamerarecorder.camera.constants.FlashCacheUtils;
...
import com.smile525.albumcamerarecorder.camera.ui.camera.impl.ICameraFragment;
import com.smile525.albumcamerarecorder.camera.ui.camera.impl.ICameraView;
...
import com.smile525.albumcamerarecorder.camera.ui.camera.state.IState;
import com.smile525.albumcamerarecorder.camera.util.LogUtil;
import com.smile525.albumcamerarecorder.constants.Constant;
import com.smile525.albumcamerarecorder.preview.BasePreviewActivity;
import com.smile525.albumcamerarecorder.settings.CameraSpec;
import com.smile525.albumcamerarecorder.settings.GlobalSpec;
import com.smile525.albumcamerarecorder.utils.PackageManagerUtils;
...
public abstract class BaseCameraFragment
    ...
    private com.smile525.albumcamerarecorder.TCameraActivity TCameraActivity;
    /**
     * 在图廊预览界面点击了确定
     */
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if (context instanceof TCameraActivity) {
            TCameraActivity = (TCameraActivity) context;
    ...
    public boolean onBackPressed() {
        ...
        if (isTrue != null) {
            ...
            if ((System.currentTimeMillis() - mExitTime) > MILLISECOND) {
                ...
                Toast.makeText(TCameraActivity.getApplicationContext(), getResources().getString(R.string.z_multi_library_press_confirm_again_to_close), Toast.LENGTH_SHORT).show();
    ...
    private void initImgFlashListener() {
        if (getFlashView() != null) {
            getFlashView().setOnClickListener(v -> {
                flashModel++;
                if (flashModel > FlashModels.TYPE_FLASH_OFF) {
    ...
    private void initCameraViewListener() {
        getCameraView().addCameraListener(new CameraListener() {
            ...
            public void onPictureTaken(@NonNull PictureResult result) {
                // 如果是自动闪光灯模式便关闭闪光灯
                if (flashModel == FlashModels.TYPE_FLASH_AUTO) {
    ...
    public void commitPictureSuccess(ArrayList<LocalFile> newFiles) {
        ...
        if (globalSpec.getOnResultCallbackListener() == null) {
            ...
            result.putParcelableArrayListExtra(Constant.EXTRA_RESULT_SELECTION_LOCAL_FILE, newFiles);
            TCameraActivity.setResult(RESULT_OK, result);
        } else {
    ...
    public void commitVideoSuccess(Intent intentPreviewVideo) {
        ...
        if (globalSpec.getOnResultCallbackListener() == null) {
            ...
            intent.putParcelableArrayListExtra(Constant.EXTRA_RESULT_SELECTION_LOCAL_FILE, localFiles);
            TCameraActivity.setResult(RESULT_OK, intent);
        } else {
    ...
    protected void initPvLayoutButtonFeatures() {
        ...
        if (cameraSpec.isClickRecord()) {
            // 禁用长按功能
            getPhotoVideoLayout().setButtonFeatures(ClickOrLongButton.BUTTON_STATE_CLICK_AND_HOLD);
            ...
            if (cameraSpec.onlySupportImages()) {
                // 禁用长按功能
                getPhotoVideoLayout().setButtonFeatures(ClickOrLongButton.BUTTON_STATE_ONLY_CLICK);
                ...
                // 禁用点击功能
                getPhotoVideoLayout().setButtonFeatures(ClickOrLongButton.BUTTON_STATE_ONLY_LONG_CLICK);
