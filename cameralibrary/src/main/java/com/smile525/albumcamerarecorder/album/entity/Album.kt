package com.smile525.albumcamerarecorder.album.entity
...
class Album internal constructor(
    ...
    companion object {
        ...
        fun valueOf(cursor: Cursor): Album {
            val column = cursor.getString(cursor.getColumnIndexOrThrow(com.smile525.albumcamerarecorder.album.loader.AlbumLoader.COLUMN_URI))
            val bucketDisplayName =
                cursor.getString(cursor.getColumnIndexOrThrow(MediaStore.Images.ImageColumns.BUCKET_DISPLAY_NAME))
            val count = cursor.getLong(cursor.getColumnIndexOrThrow(com.smile525.albumcamerarecorder.album.loader.AlbumLoader.COLUMN_COUNT))
            return Album(
