...
import static com.smile525.common.enums.Constant.IMAGE;
import static com.smile525.common.enums.Constant.IMAGE_VIDEO;
import static com.smile525.common.enums.Constant.VIDEO;
...
import com.smile525.common.enums.Constant;
import com.smile525.albumcamerarecorder.R;
import com.smile525.albumcamerarecorder.album.entity.SelectedCountMessage;
import com.smile525.albumcamerarecorder.album.utils.PhotoMetadataUtils;
import com.smile525.albumcamerarecorder.settings.AlbumSpec;
import com.smile525.albumcamerarecorder.utils.SelectableUtils;
import com.smile525.common.entity.IncapableCause;
...
public class SelectedItemCollection {
    ...
    public IncapableCause isAcceptable(MultiMedia item) {
        ...
        if (!AlbumSpec.INSTANCE.getMediaTypeExclusive()) {
            // 混合检查
            getSelectCount();
            if (Objects.requireNonNull(item.getMimeType()).startsWith(Constant.IMAGE)) {
            ...
            } else if (item.getMimeType().startsWith(Constant.VIDEO)) {
