...
class AlbumCompressFileTask(
            ...
            if (path != null) {
                ...
                if (newFile.exists()) {
                    ...
                    if (item.isImage()) {
                        ...
                        // 移动到新的文件夹
                        com.smile525.albumcamerarecorder.camera.util.FileUtil.copy(compressionFile, newFile)
                        newLocalFiles.add(
                            LocalFile(
                                context,
    ...
    fun getPath(item: LocalFile): String? {
        ...
        if (item.path == null) {
            val file = com.smile525.common.utils.UriUtils.uriToFile(context, item.uri)
            if (file != null) {
        ...
        if (path != null) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                ...
                if (cacheFile != null) {
                    com.smile525.albumcamerarecorder.camera.util.FileUtil.copy(context, item.uri, cacheFile)
