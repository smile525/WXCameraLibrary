package com.smile525.albumcamerarecorder.album.engine
...
/**
 * 图片不同加载方式
 * Image loader interface. There are predefined [com.smile525.albumcamerarecorder.album.engine.impl.GlideEngine]
 * and [com.smile525.albumcamerarecorder.album.engine.impl.PicassoEngine].
 * @author zhongjh
 */
